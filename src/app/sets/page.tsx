...
export default function SetsPage() {
  const [activeEra, setActiveEra] = React.useState("Scarlet & Violet");
    ...
    <div className="flex min-h-screen w-full flex-col bg-background">
      ...
      <div className="flex flex-1">
        <aside className="hidden md:flex flex-col w-64 p-6 border-r border-border">
          <h2 className="text-sm font-semibold text-muted-foreground mb-4">ERA</h2>
          <nav className="flex flex-col gap-1">
            {eras.map((era) => (
              <button
                ...
                className={cn(
                  "px-3 py-1.5 text-left rounded-md text-sm transition-colors",
                  activeEra === era
        ...
        <main className="flex-1 p-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-4 md:gap-6">
                <div className="flex items-center space-x-2">
                    ...
                    <label htmlFor="english" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 border-b-2 border-primary pb-1">
                        English
                    </label>
                </div>
                 <div className="flex items-center space-x-2">
                    <Checkbox id="japanese" disabled/>
                    <label htmlFor="japanese" className="text-sm font-medium leading-none text-muted-foreground/50 peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                        Japanese
                    </label>
                </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
                 <Image src="https://placehold.co/40x40.png" width={40} height={40} alt={`${activeEra} logo`} data-ai-hint={`${activeEra} logo`} />
                <h2 className="text-2xl font-semibold">{activeEra}</h2>
            </div>
